...
extern "C" {
    ...
    enum lm_ggml_type {
        ...
        // 40 is LM_GGML_TYPE_NVFP4 in upstream llama.cpp
        LM_GGML_TYPE_Q1_0_g128 = 41,
        LM_GGML_TYPE_Q1_0    = 42,
    ...
    enum lm_ggml_ftype {
        ...
        LM_GGML_FTYPE_MOSTLY_Q1_0_g128 = 27, // except 1d tensors
        LM_GGML_FTYPE_MOSTLY_Q1_0    = 28, // except 1d tensors
    };
