...
void quantize_row_q1_0_g128_ref(const float * LM_GGML_RESTRICT x, block_q1_0_g128 * LM_GGML_RESTRICT y, int64_t k) {
...
void dequantize_row_q1_0_g128(const block_q1_0_g128 * LM_GGML_RESTRICT x, float * LM_GGML_RESTRICT y, int64_t k) {
    static const int qk = QK1_0_g128;
...
size_t quantize_q1_0_g128(const float * LM_GGML_RESTRICT src, void * LM_GGML_RESTRICT dst, int64_t nrow, int64_t n_per_row, const float * quant_weights) {
    if (!quant_weights) {
        quantize_row_q1_0_g128_ref(src, dst, (int64_t)nrow*n_per_row);
        return nrow * lm_ggml_row_size(LM_GGML_TYPE_Q1_0_g128, n_per_row);
    }
    size_t row_size = lm_ggml_row_size(LM_GGML_TYPE_Q1_0_g128, n_per_row);
    char * qrow = (char *)dst;
    for (int64_t row = 0; row < nrow; ++row) {
