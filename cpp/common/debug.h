...
template <bool abort_on_nan> void common_debug_print_tensor(uint8_t * data, lm_ggml_type type, const int64_t * ne, const size_t * nb, int64_t n);

// Intended to use as callback for lm_ggml_backend_sched_eval_callback
