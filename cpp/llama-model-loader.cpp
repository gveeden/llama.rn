...
namespace GGUFMeta {
    ...
    bool llama_model_loader::get_key_or_arr(enum llm_kv kid, uint32_t & result, bool required) {
        ...
        const int id = lm_gguf_find_key(meta.get(), key.c_str());
        ...
        if (lm_gguf_get_kv_type(meta.get(), id) == LM_GGUF_TYPE_ARRAY) {
            if (required) {
...
llama_model_loader::llama_model_loader(
    ...
    // TODO: make optional
    {
        ...
        switch (type_max) {
            ...
            case LM_GGML_TYPE_Q1_0_g128: ftype = LLAMA_FTYPE_MOSTLY_Q1_0_g128; break;
            default:
                {
